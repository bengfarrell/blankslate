...
try:
    ...
    from thelearningtablet.mockbytes import create_mock_hid_reader, MockHIDReader, create_config_based_generator
    from thelearningtablet.utils import find_and_open_device
